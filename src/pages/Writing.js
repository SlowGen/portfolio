    ...
    <section id="wrapper">
      <header>
        <div className="inner">
          ...
          <p>I wrote this piece as part of an assignment for graduation. Despite
          being a requirement, it is a topic I am passionate about and what inspired
          me to create 
          <a href="http://www.checkson.me" target="_blank"
            rel="noopener noreferrer"> ChecksOn.Me </a> 
            </p>
        </div>
      </header>
      ...
      <div className="wrapper">
        <div className="inner">
          <h2 className="major">Contactless Payments</h2>
          <h3 className="major">Why it isn't truly contactless and what we can do to fix it</h3>
          <p>
        ...
        <h3>
          <u>
            <a href="https://electronics.howstuffworks.com/difference-between-rfid-and-nfc.htm"
            target="_blank"
            rel="noopener noreferrer"
            >More on RFID and NFC here!</a>
          </u>
        </h3>
        <p>
